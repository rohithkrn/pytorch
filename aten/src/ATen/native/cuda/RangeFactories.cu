...
Tensor& linspace_cuda_out(Tensor& result, Scalar start, Scalar end, int64_t steps) {
  ...
  if (steps == 0) {
    ...
    AT_DISPATCH_ALL_TYPES_AND2(at::ScalarType::Half, at::ScalarType::BFloat16, r.scalar_type(), "linspace_cuda", [&]() {
...
Tensor& logspace_cuda_out(Tensor& result, Scalar start, Scalar end, int64_t steps, double base) {
  ...
  if (steps == 0) {
    ...
    AT_DISPATCH_ALL_TYPES_AND2(at::ScalarType::Half, at::ScalarType::BFloat16, r.scalar_type(), "logspace_cuda", [&]() {
