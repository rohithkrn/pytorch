...
Tensor flip_cuda(const Tensor& self, IntArrayRef dims) {
  ...
  if (flip_dims_size == 1 && in_tensor.is_contiguous() && (flip_dims[0] == 0 || flip_dims[0] == total_dims - 1)) {
    AT_DISPATCH_ALL_TYPES_AND3(at::ScalarType::Half, at::ScalarType::BFloat16, at::ScalarType::Bool, in_tensor.scalar_type(), "flip_cuda", [&] {
  ...
  AT_DISPATCH_ALL_TYPES_AND2(at::ScalarType::Half, at::ScalarType::BFloat16, in_tensor.scalar_type(), "flip_cuda", [&] {
...
Tensor roll_cuda(const Tensor& self, IntArrayRef shifts, IntArrayRef dims) {
  ...
  AT_DISPATCH_ALL_TYPES_AND3(at::ScalarType::Half, at::ScalarType::BFloat16, at::ScalarType::Bool, in_tensor.scalar_type(), "roll_cuda", [&] {
