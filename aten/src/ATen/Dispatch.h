...
#define AT_DISPATCH_FLOATING_TYPES_AND2(SCALARTYPE1, SCALARTYPE2, TYPE, NAME, ...)                                       \
 ...
 #define AT_DISPATCH_FLOATING_AND_COMPLEX_TYPES_AND1(SCALARTYPE1, SCALARTYPE2, TYPE, NAME, ...)                                \
  [&] {                                                                                                          \
    const auto& the_type = TYPE;                                                                                 \
    /* don't use TYPE again in case it is an expensive or side-effect op */                                      \
    at::ScalarType _st = ::detail::scalar_type(the_type);                                                        \
  ...
  #define AT_DISPATCH_FLOATING_AND_COMPLEX_TYPES_AND2(SCALARTYPE, TYPE, NAME, ...)                                \
  [&] {                                                                                                          \
    const auto& the_type = TYPE;                                                                                 \
    /* don't use TYPE again in case it is an expensive or side-effect op */                                      \
    at::ScalarType _st = ::detail::scalar_type(the_type);                                                        \
