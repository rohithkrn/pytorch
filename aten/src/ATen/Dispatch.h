...
// This macro should be used to skip bfloat16 dispatch on non-ROCm platforms.
// This should not be used once the bfloat16 bringup is complete on other platforms.
